...
export declare class LazyRenderer {
    ...
    writeTextureBlob(textureName: string, srcBlob: Blob, srcDepth?: number, textureXOffset?: number, textureYOffset?: number, textureZOffset?: number, srcXOffset?: number, srcYOffset?: number, srcZOffset?: number, regionWidth?: number, regionHeight?: number, regionDepth?: number): void;
    ...
    readTextureURL(textureName: string, mimeType?: string, dstWidth?: number, dstHeight?: number, dstDepth?: number, textureXOffset?: number, textureYOffset?: number, textureZOffset?: number, dstXOffset?: number, dstYOffset?: number, dstZOffset?: number, regionWidth?: number, regionHeight?: number, regionDepth?: number): string;
